...
<!-- birthday -->
 <div class="form-group">
                ...
                <input value='{{ $manager->birthday }}' type="date" id="birthday" name="birthday" class="@error('birthday') is-invalid @enderror form-control">
                        @error('birthday')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror  
        </div> 
...
<div class="form-group">
                ...
                <input value='{{ $manager->wday }}' type="date" id="wday" name="wday" class="@error('wday') is-invalid @enderror form-control">
                        @error('wday')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror  
        </div>
